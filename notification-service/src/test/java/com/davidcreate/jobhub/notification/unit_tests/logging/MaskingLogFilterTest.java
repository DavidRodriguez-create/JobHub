package com.davidcreate.jobhub.notification.unit_tests.logging;

import com.davidcreate.jobhub.notification.logging.MaskingLogFilter;
...
class MaskingLogFilterTest {
    ...
    void leavesNonSensitiveTextUntouched() {
        String line = "-> GET /notifications (NotificationResource.list)";
