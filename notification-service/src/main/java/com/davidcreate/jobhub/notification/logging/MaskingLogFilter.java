package com.davidcreate.jobhub.notification.logging;
 ...
 * our own logs, the HTTP access log, the per-endpoint payload log, and any
 * framework-emitted message — before it reaches a handler.
 *
