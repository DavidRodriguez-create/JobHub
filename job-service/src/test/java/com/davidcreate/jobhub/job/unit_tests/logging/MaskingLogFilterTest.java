package com.davidcreate.jobhub.job.unit_tests.logging;

import com.davidcreate.jobhub.job.logging.MaskingLogFilter;
...
class MaskingLogFilterTest {
    ...
    void leavesNonSensitiveTextUntouched() {
        String line = "-> POST /jobs/admin/triggers (AdminTriggerResource.trigger)";
