package com.davidcreate.jobhub.application.unit_tests.adapter.in.rest.filter;

import com.davidcreate.jobhub.application.adapter.in.rest.filter.ServiceKeyFilter;
...
/**
 * Plain JUnit 5 unit test using a hand-written {@code FakeRequestContext} rather than Mockito
 * mocks for {@code ContainerRequestContext}/{@code UriInfo} -- Mockito's inline mock maker
 * cannot reliably instrument {@code jakarta.ws.rs} interfaces when run in the same Surefire
 * fork as {@code @QuarkusTest} classes.
 */
@DisplayName("ServiceKeyFilter")
class ServiceKeyFilterTest {
    ...
    void allowsMatchingKey() {
        FakeRequestContext requestContext = new FakeRequestContext(
                "internal/users/11111111-1111-1111-1111-111111111111/interest-profile", EXPECTED_KEY);
    ...
    @Test
    @DisplayName("aborts with 401 when X-Service-Key header is missing")
    void rejectsMissingKey() {
        FakeRequestContext requestContext = new FakeRequestContext(
                "internal/users/11111111-1111-1111-1111-111111111111/interest-profile", null);
    ...
    @Test
    @DisplayName("aborts with 401 when X-Service-Key header does not match")
    void rejectsWrongKey() {
        FakeRequestContext requestContext = new FakeRequestContext(
                "internal/users/11111111-1111-1111-1111-111111111111/interest-profile", "wrong-value");
    ...
    void passesThroughNonInternalPaths() {
        FakeRequestContext requestContext = new FakeRequestContext("applications", null);
