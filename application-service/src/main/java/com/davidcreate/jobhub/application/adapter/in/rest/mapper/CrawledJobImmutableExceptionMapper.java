...
@Provider
public class CrawledJobImmutableExceptionMapper
        implements ExceptionMapper<CrawledJobImmutableException> {

    @Override
    public Response toResponse(CrawledJobImmutableException ex) {
